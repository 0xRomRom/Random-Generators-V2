  ...
  return (
    <div className={cl["main-div"]}>
      ...
      <div className={cl["terms-box"]}>
        ...
        <p>
          Random Generator follows a standard procedure of using log files.
        ...
        <p>
          Like any other website, Random Generator uses 'cookies'. These cookies
        ...
        <p>
          ...
          advertising partners of Random Generator.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Random Generator, which are
        ...
        <p>
          Note that Random Generator has no access to or control over these
        ...
        <p>
          Random Generator's Privacy Policy does not apply to other advertisers
        ...
        <p>
          Random Generator does not knowingly collect any Personal Identifiable
