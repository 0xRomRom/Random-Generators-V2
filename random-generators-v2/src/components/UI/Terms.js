  ...
  return (
    <div className={cl["main-div"]}>
      ...
      <div className={cl["terms-box"]}>
        ...
        <p>Welcome to Random Generators!</p>
        ...
        <p>
          ...
          conditions. Do not continue to use Random Generators if you do not
        ...
        <p>
          We employ the use of cookies. By accessing Random Generators, you
          agreed to use cookies in agreement with the Random Generators's
          Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Random Generators and/or its licensors own
          the intellectual property rights for all material on Random
          Generators. All intellectual property rights are reserved. You may
          access this from Random Generators for your own personal use subjected
          to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Random Generators</li>
          <li>Sell, rent or sub-license material from Random Generators</li>
        ...
        <p>
          ...
          Random Generators does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Random Generators,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their
          views and opinions. To the extent permitted by applicable laws, Random
          Generators shall not be liable for the Comments or for any liability,
        ...
        <p>
          Random Generators reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Random Generators a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Random Generators; and (d)
        ...
        <p>
          ...
          sending an e-mail to Random Generators. Please include your name, your
        ...
        <p>
          No use of Random Generators's logo or other artwork will be allowed
